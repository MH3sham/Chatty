...
public class FindFriendsListAdapter extends RecyclerView.Adapter<FindFriendsListAdapter.UserViewHolder>{
    ...
    public FindFriendsListAdapter(ArrayList<User> mUserList , Context context) {
    ...
    @NonNull
    @Override
    public FindFriendsListAdapter.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_user, null, false);
        RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        layoutView.setLayoutParams(lp);

        FindFriendsListAdapter.UserViewHolder rcv = new FindFriendsListAdapter.UserViewHolder(layoutView);
        return rcv;
    }

    @Override
    public void onBindViewHolder(@NonNull final FindFriendsListAdapter.UserViewHolder holder, final int position) {
